...
// UpdateClusterNotModifiedCode is the HTTP code returned for type UpdateClusterNotModified
const UpdateClusterNotModifiedCode int = 304

/*UpdateClusterNotModified no update required

swagger:response updateClusterNotModified
*/
type UpdateClusterNotModified struct {
}

// NewUpdateClusterNotModified creates UpdateClusterNotModified with default headers values
...
// WriteResponse to the client
func (o *UpdateClusterNotModified) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
